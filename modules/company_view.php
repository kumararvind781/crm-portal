                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <div class="fw-semibold">
                                                <?php echo esc(ucfirst($row['communication_type'] ?? '-')); ?></div>
            ...
            <div id="companyManualResponseCollapse" class="collapse">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <?php foreach ($companyResponses as $row): ?>
                                        ...
                                        <div>
                                            ...
                                            <h6 class="mb-1">
                                                ...
                                                <?php if ($row['communication_by'] == "Client"): ?>
                                                    ...
                                                    <a href="<?= BASE_URL ?>modules/client_view.php?id=<?= $row['client_id'] ?>"
